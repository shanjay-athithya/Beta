...
function App() {
  ...
  async function generateAnswer(e) {
    ...
    // Check if the question is job-related or a greeting
  ...
  function checkIfJobRelated(question) {
    const jobKeywords = [
      ...
      "job market analysis template",
      "job market research report",
      "job market research template",
      "job market trends report",
      "job market trends template",
      "job market statistics report",
      "job market statistics template",
      "job market outlook report",
      "job market outlook template",
      "job market forecast report",
      "job market forecast template",
      "job market report template",
      "job market data report",
      "job market data template",
      "job market analysis data",
      "job market analysis data report",
      "job market analysis data template",
      "job market research data",
      "job market research data report",
      "job market research data template",
      "job market trends data",
      "job market trends data report",
      "job market trends data template",
      "job market statistics data",
      "job market statistics data report",
      "job market statistics data template",
      "job market outlook data",
      "job market outlook data report",
      "job market outlook data template",
      "job market forecast data",
  ...
  // Function to get a response for the greeting
    ...
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center">
      <div className="w-full md:w-2/3 lg:w-1/2 flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
        <header className="bg-blue-700 text-white text-center p-4">
          <h1 className="text-2xl font-bold">ChatBot For Job Opportunities</h1>
        </header>
        ...
        <footer className="p-4 bg-gray-100">
          <div className="flex">
            ...
            <button
              ...
              className={`bg-blue-600 text-white py-2 px-4 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:opacity-50 ${
                generatingAnswer ? "animate-pulse" : "hover:bg-blue-700"
              }`}
